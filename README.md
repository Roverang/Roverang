...
- 🌍 Regional Community Management Intern @ **HYPEDIN** — Google Student Ambassador Program, Punjab
- 🚀 Building **VidyAstra AI** and **Xplore-X**, showcased at the Indian Sports Goods Expo (ISGE)
...
**🤖 [VidyAstra AI](https://github.com/Roverang/REPO-NAME)**
AI-powered academic assistant for NIT Jalandhar students using LLMs + RAG for syllabus-aware query resolution and semester planning.
`Python` `LLMs` `RAG`

</td>
<td width="50%">

**🎪 [Xplore-X](https://github.com/Roverang/REPO-NAME)**
Campus engagement platform connecting students, clubs, organizers & brands. Showcased at the Indian Sports Goods Expo alongside Decathlon & COSCO.
...
**🛡️ [CTF & Incident Response Framework](https://github.com/Roverang/REPO-NAME)**
Deployed Capture The Flag infrastructure for institute-level cybersecurity competitions, plus a Cyber Crisis Management Plan for real-world incident response.
`Cybersecurity` `Infra`

</td>
<td width="50%">

**♻️ [ReWear](https://github.com/Roverang/REPO-NAME)**
Full-stack platform for listing, discovering, and exchanging reusable clothing to promote sustainable fashion.
`React` `Firebase` `Auth`
...
<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=Roverang&theme=radical&hide_border=true" />
</p>
...
- 🇮🇳 **Smart India Hackathon** — Team project shortlisted at national level
